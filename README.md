...
| `activity_since` | Whether anything happened after an instant — counts and newest timestamps for new messages, mentions of you, and bookmark additions, with no content |
